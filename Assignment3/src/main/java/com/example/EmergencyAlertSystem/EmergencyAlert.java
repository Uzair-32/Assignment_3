package com.example.EmergencyAlertSystem;

import com.example.Health_Data_Handling.VitalSign;
...
public class EmergencyAlert {
    ...
    public void sendAlert(String alertMessage) {
        ...
        notifier.sendEmail(patientEmail, alertMessage);
        ...
        if (patient.getAssignedDoctor() != null) {
            ...
            notifier.sendEmail(doctorEmail, alertMessage);
